...
void InfixToPostfix(char infix_exp[], char postfix_exp[])
{
    ...
    while(item != '\0')        /* run loop till end of infix expression */
    {
        ...
        else if(is_operator(item) == 1)        /* means symbol is operator */
        {
            ...
            push(x);
            /* because just above while loop will terminate we hav popped one extra item
    ...
    postfix_exp[j] = '\0'; // Adding null character in the end
}

/* main function begins */
int main()
{
    char infix[SIZE], postfix[SIZE], decision;         /* declare infix string and postfix string */

    printf("Note:\n"
           "The infix expression can only contain the following:\n"
           "1. contain single letter variables and single digit constants only.\n"
           "2. The length of the expression cannot be more than 100.\n");
    do{
